...
>
    ...
    <div class="h-18 flex items-center gap-3 px-5 border-b border-white/10 shrink-0">
        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-navy-500 to-navy-400 flex items-center justify-center shrink-0">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-6 scrollbar-thin">
        ...
        <div>
            ...
            {{-- Persetujuan Ijin (Petugas Piket) --}}
            @role('petugas_piket')
            @php
            ...
            @endphp
                ...
                <span class="sidebar-text">Persetujuan Ijin</span>
