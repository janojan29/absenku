        ...
        <div class="space-y-1.5">
            ...
            <div class="relative">
                ...
                <button
                    ...
                    class="password-toggle-btn absolute right-4 top-1/2 -translate-y-1/2 text-bw-400 hover:text-navy-500 focus:outline-none"
                >
                    <svg :class="showPassword ? '' : 'hidden'" class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" aria-hidden="true">
