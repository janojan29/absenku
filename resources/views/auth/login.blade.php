        ...
        <div class="space-y-1.5">
            ...
            <div class="relative">
                ...
                <button
                    ...
                    class="password-toggle-btn absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-bw-400 hover:text-navy-500 transition-colors duration-150 focus:outline-none"
                >
                    <span x-show="!showPassword" x-cloak class="absolute inset-0 flex items-center justify-center" aria-hidden="true">
                        <svg class="w-5 h-5 pointer-events-none" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    ...
                    <span x-show="showPassword" x-cloak class="absolute inset-0 flex items-center justify-center" aria-hidden="true">
                        <svg class="w-5 h-5 pointer-events-none" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774" />
