        ...
        @if (! $otpSentAt)
            ...
            <div class="space-y-1.5">
                ...
                <input
                    ...
                    autofocus
                    autocomplete="email"
                    placeholder="nisn@gmail.com atau nip@gmail.com"
                    class="form-input"
                >
                @if ($errors->has('email'))
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <button
                        ...
                        class="password-toggle-btn absolute right-3 top-1/2 -translate-y-1/2 text-bw-400 hover:text-navy-500 focus:outline-none"
