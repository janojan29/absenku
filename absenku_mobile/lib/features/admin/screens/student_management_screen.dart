// File ini berisi layar pengelolaan data siswa.
// Admin dapat melihat, menambah, mengubah, atau menghapus data siswa melalui antarmuka ini.
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final parentWa = _parentWhatsappController.text.trim();
                    ...
                    if (nis.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('NISN wajib diisi!')),
                      );
                      return;
                    }
                    if (nis.length > 50) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('NISN maksimal 50 karakter!')),
                      );
                      return;
                    }
